...
export const toolboxCategories: Record<string, ToolboxItem[]> = {
  'Basic Elements': [
    { id: 'datanode', name: 'Data Node', type: 'DataNode', icon: '📦', color: '#6B7280', category: 'Basic Elements' }
  ],
  ...
  'Data Formats': [
    ...
    { id: 'xml', name: 'XML', type: 'XML', icon: '📄', color: '#059669', category: 'Data Formats' },
    ...
    { id: 'rdf', name: 'RDF', type: 'RDF', icon: '🔗', color: '#7C3AED', category: 'Data Formats' },
    ...
    { id: 'audio', name: 'Audio', type: 'Audio', icon: '🎵', color: '#B45309', category: 'Data Formats' },
    ...
    { id: 'gpsdata', name: 'GPS Data', type: 'GPSData', icon: '🗺️', color: '#16A34A', category: 'Data Formats' }
  ],
  
  'Storage Types': [
    { id: 'filesystem', name: 'File System', type: 'File_System', icon: '💾', color: '#374151', category: 'Storage Types' },
    ...
    { id: 'columndb', name: 'Column DB', type: 'ColumnOriented', icon: '📋', color: '#7C3AED', category: 'Storage Types' },
  ...
  'Processing Types': [
    ...
    { id: 'batch', name: 'Batch', type: 'Batch', icon: '📦', color: '#7C3AED', category: 'Processing Types' }
  ],
  ...
  'Data Operations': [
    ...
    { id: 'classify', name: 'Classify', type: 'Classify', icon: '📂', color: '#7C3AED', category: 'Data Operations' },
    { id: 'sort', name: 'Sort', type: 'Sort', icon: '🔢', color: '#059669', category: 'Data Operations' },
    ...
    { id: 'archive', name: 'Archive', type: 'Archive', icon: '📦', color: '#6B7280', category: 'Data Operations' },
    ...
    { id: 'verifydata', name: 'Verify Data', type: 'VerifyData', icon: '✅', color: '#059669', category: 'Data Operations' }
  ],
